...
org_path = r'D:\Double-digit-yolo-detection-on-aircraft\datasets\pose\splited'
dst_path = r'D:\Double-digit-yolo-detection-on-aircraft\datasets\pose\for trainning'
