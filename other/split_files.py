...
org_path = r'D:\Double-digit-yolo-detection-on-aircraft\datasets\obb\background'
dst_path = r'D:\Double-digit-yolo-detection-on-aircraft\datasets\obb\background splited'
